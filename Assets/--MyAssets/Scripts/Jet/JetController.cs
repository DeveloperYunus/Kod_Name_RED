...
public class JetController : MonoBehaviour
{
    ...
    [Header("--- Texts ---")]
    [SerializeField] private TextMeshProUGUI throttleTxt;
    ...
    {   
        ...
        {            
            ...
            else if (_forwardSpeed > 90) //hýzým 90 dan büyükse ekipmaný yukarý çek
            {
                gearOpen = false;
    ...
    private void FixedUpdate()
    {
        ...
        if (jetVFXTimer < 0)
        {
            ...
            if (throttleAmount > 0)
            {
                ...
                _enginePower = throttleAmount * m_MaxEnginePower;
        ...
        speedTxt.text = (_forwardSpeed * 2).ToString("0.0") + " km/h";
    ...
    private void CalculateDrag()
    {
        ...
        rb.angularDrag = originalAngularDrag * _forwardSpeed;
    }
    ...
    private void CaluclateAerodynamicEffect()
    {
        ...
        if (rb.velocity.magnitude > 0.1)
        {
            ...
            _aeroFactor = Vector3.Dot(transform.forward, rb.velocity.normalized);
            ...
            var newVelocity = Vector3.Lerp(rb.velocity, transform.forward * _forwardSpeed,
                                           _aeroFactor * _forwardSpeed * m_AerodynamicEffect * Time.deltaTime);
    ...
    private void CalculateLinearForces()
    {
        ...
        forces += _enginePower * transform.forward;
        ...
        var zeroLiftFactor = Mathf.InverseLerp(m_ZeroLiftSpeed, 0, _forwardSpeed);
        // Lift kuvvetini hesapla ve ekle
        var liftPower = _forwardSpeed * _forwardSpeed * m_Lift * zeroLiftFactor * _aeroFactor;
    ...
    private void CalculateTorque()
    {
        ...
        rb.AddTorque(_forwardSpeed * _aeroFactor * torque);
    }
